                ...
                <div class="card-body">
                  ...
                  <?php
                    if(!empty($_POST)){
                      ...
                      $sel="SELECT * FROM iphone_user WHERE user_username='$username' AND user_password='$password'";
                      ...
                      if($data){
                        ...
                        echo "UserName and Password did't match..!!";
                      }
                    }
                  ?>
                  <form class="form-signin" method="post" action="">
                    <input type="text" class="form-control mb-2" name="username" placeholder="User Name" required autofocus>
